class TestData:
    test_data_user1 = ['Илья', 'Тихонов', 'Теплый стан, 13', 'Беляево', '+79858545555', '28.05.2026',
                 'Круто']

    test_data_user2 = ['Дмитрий', 'Коньков', 'Теплый стан, 15', 'Коньково', '+79858544444', '28.05.2026',
                 'Удачно']
